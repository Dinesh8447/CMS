...
export const Label =
  "font-bold text-lg bg-blue-700 shadow-xl text-white px-2 py-1 rounded-lg";
export const Input = "border-2 px-2 py-1 text-sm";
export const select ='bg-gray-50 border border-gray-300 text-gray-900 text-sm font-bold rounded-lg focus:ring-blue-500 focus:border-blue-300 block w-full p-2.5'
